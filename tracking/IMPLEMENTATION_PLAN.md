...
| R | Report build (post-plan, DEC-008) | Complete | 2026-06-14 | Tier-1 presentation layer. Filled the Quarto scaffold (`report/*.qmd`) from validated outputs only — overview + food-security + RQ1/2/3. Figures regenerated in-cell from committed tables via `viz` (validated-only gate shown: 63/63 flood, 48/48 fire). Cells verified against `f_f` (Quarto not installed). Honours DEC-005/015/023/033/039 caveats; corrects loss attribution (Raqqa largest, Hasakah-June flagged) |
