...
- `ndvi_anomaly_2025.tif` — NDVI anomaly on cropland (drought stress).
- `rainfall_deficit.csv` — CHIRPS rainfall deficit, Nov 2024–May 2025.
- `production_baseline.csv` — GIEWS ~1.2 Mt production floor disaggregated by
  governorate.
